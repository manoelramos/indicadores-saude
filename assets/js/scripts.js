		...
		modalBody: `
			<div class="row justify-content-center pt-4">
				<div class="col-12 col-md-11 col-lg-10 creditos-curso">
					...
					<p class="mb-5">Indicadores para a saúde: aspectos teóricos e práticos</p>
					...
					<div class="mb-5">
						<p class="creditos-modulo mb-2 mt-4">Módulo 1: Conceitos básicos em indicadores para a saúde</p>
						<p class="mb-1">Carolina de Campos Carvalho</p>
						<p class="small text-muted mb-0"><em>Instituto de Comunicação e Informação Científica e Tecnológica em Saúde - Icict/Fiocruz</em></p>
						...
						<p class="small text-muted mb-0"><em>Instituto de Comunicação e Informação Científica e Tecnológica em Saúde - Icict/Fiocruz</em></p>
						<p class="small text-muted mb-3"><em>[Aulas 1 e 2]</em></p>
						<p class="creditos-modulo mb-2 mt-4">Módulo 2: Calculando indicadores</p>
						<p class="mb-1">Wanessa da Silva de Almeida</p>
						<p class="small text-muted mb-0"><em>Instituto Nacional de Infectologia Evandro Chagas - INI/Fiocruz</em></p>
						<p class="small text-muted mb-3"><em>[Aulas 1 e 2]</em></p>
						<p class="mb-1">Carolina de Campos Carvalho</p>
						<p class="small text-muted mb-0"><em>Instituto de Comunicação e Informação Científica e Tecnológica em Saúde - Icict/Fiocruz</em></p>
						...
						<p class="small text-muted mb-0"><em>Instituto de Comunicação e Informação Científica e Tecnológica em Saúde - Icict/Fiocruz</em></p>
						<p class="small text-muted mb-3"><em>[Aulas 3 e 4]</em></p>
						<p class="creditos-modulo mb-2 mt-4">Módulo 3: Uso de indicadores</p>
						<p class="mb-1">Carolina de Campos Carvalho</p>
						<p class="small text-muted mb-0"><em>Instituto de Comunicação e Informação Científica e Tecnológica em Saúde - Icict/Fiocruz</em></p>
						<p class="small text-muted mb-3"><em>[Aulas 1 e 2]</em></p>
						<p class="mb-1">Aline Pinto Marques</p>
