			...
			<div class="row justify-content-center pt-4">
				<div class="col-12 col-md-11 col-lg-10 creditos-curso">
					...
					<div class="mb-5">
						...
						<span class="h6 mb-3 d-block">Suporte de Tecnologia da Informação</span>
					...
					<div class="mb-5">
						...
						<p class="mb-1">Wanessa da Silva de Almeida</p>
						<p class="small text-muted mb-0"><em>Instituto de Comunicação e Informação Científica e Tecnológica em Saúde - Icict/Fiocruz</em></p>
						<p class="small text-muted mb-3"><em>[Aulas 1 e 2]</em></p>
						<p class="mb-1">Giseli Nogueira Damacena</p>
						<p class="small text-muted mb-0"><em>Instituto de Comunicação e Informação Científica e Tecnológica em Saúde - Icict/Fiocruz</em></p>
						<p class="small text-muted mb-3"><em>[Aulas 1 e 3]</em></p>
						...
						<p class="mb-1">Jessica Muzy Rodrigues</p>
						<p class="small text-muted mb-0"><em>Instituto de Comunicação e Informação Científica e Tecnológica em Saúde - Icict/Fiocruz</em></p>
						<p class="small text-muted mb-3"><em>[Aulas 2 e 3]</em></p>
						<p class="mb-1">Rogelio Eduardo Fernandez Menjivar</p>
						<p class="small text-muted mb-0"><em>Consultor Independente</em></p>
						<p class="small text-muted mb-3"><em>[Aula 3]</em></p>
						<p class="mb-1">Leo Ramos Maia</p>
						<p class="small text-muted mb-0"><em>Instituto de Comunicação e Informação Científica e Tecnológica em Saúde - Icict/Fiocruz</em></p>
						<p class="small text-muted mb-3"><em>[Aula 4]</em></p>
						<p class="mb-1">Mônica de Avelar Figueiredo Mafra Magalhães</p>
						<p class="small text-muted mb-0"><em>Instituto de Comunicação e Informação Científica e Tecnológica em Saúde - Icict/Fiocruz</em></p>
						<p class="small text-muted mb-3"><em>[Aula 5]</em></p>
						<p class="creditos-modulo mb-2 mt-4">Módulo 4: Interoperabilidade de Sistemas</p>
						<p class="mb-1">José Nildo de Barros Silva Júnior</p>
						<p class="small text-muted mb-0"><em>Instituto de Comunicação e Informação Científica e Tecnológica em Saúde - Icict/Fiocruz</em></p>
						<p class="small text-muted mb-3"><em>[Aulas 1 e 2]</em></p>
					</div>
				</div>
